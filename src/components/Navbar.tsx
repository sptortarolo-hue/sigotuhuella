...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-brand-bg/95 backdrop-blur-md border-b border-brand-accent hidden md:block">
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="relative z-50 md:hidden overflow-y-auto max-h-[calc(100dvh-4rem)] bg-brand-bg border-b border-brand-accent px-4 py-4 flex flex-col gap-2"
            >
            {navItems.map((item) => (
              <Link
                key={item.path}
